...
<div class="box-header with-border">
  <h1 class="box-title">Tiendas <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
...
<div class="panel-body" style="height: 400px;" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
     ...
     <select name="idorganizacion" id="idorganizacion" class="form-control select-picker" required>
     </select>
    </div>
