...
//Función para verificar el acceso al sistema
    ...
    {
    	$sql="SELECT u.idusuario,u.nombre,u.apellidos,u.login,u.idtipousuario,u.iddepartamento,u.login, tu.nombre as tipousuario FROM usuarios u INNER JOIN tipousuario tu ON u.idtipousuario=tu.idtipousuario WHERE login='$login' AND password='$clave' AND estado='1'"; 
    	return ejecutarConsulta($sql);  
    }
}
