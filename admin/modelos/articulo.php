...
class Articulo {
    ...
    public function listar() {
       ...
       //$sql = "SELECT a.nombre, a.codigo,a.descripcion, a.marca, a.modelo, a.puerto, a.generacion, a.ram, a.rom , a.idcategoria, a.fechacreada as categoria FROM articulo as a INNER JOIN categoria as c ON a.idcategoria = c.idcategoria";
    ...
    public function listar() {
        $sql = "SELECT a.idarticulo, a.nombre, a.codigo, a.descripcion, a.marca, a.modelo, 
                       a.puerto, a.generacion, a.ram, a.rom, c.nombre AS categoria, 
                       a.fechacreada, a.estado 
                FROM articulo AS a 
